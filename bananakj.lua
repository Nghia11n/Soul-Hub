...
local Window = Fluent:CreateWindow({
    Title = "Banana Hub-Blox Fruits",
    SubTitle = "YT: Nghiarobloxtt",
    TabWidth = 160,
...
ImageButton.Image = "http://www.roblox.com/asset/?id=17451008055"
...
Tabs.Main:AddButton({
    Title = "Bấm Vào Đây Sẽ Rất Hay"
    Description = "Bấm Vào Sẽ Giống Banana Hub Hơn",
    Callback = function()
        _G.JoinTeam = "Pirates"
        _G.Stop_If_Has_Items = true
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Nghia11n/Banana-Hub/main/bananabutton.lua"))()
    end
})
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        _G.JoinTeam = "Pirates"
        _G.Stop_If_Has_Items = true
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Nghia11n/Banana-Hub/main/bananachest.lua"))()
    end
})

Tabs.Misc:AddButton({
	Title = "Bấm Vào Đây Để Sao Chép Link Discord",
	Description = "Discord Chính Thức",
	Callback = function()
 setclipboard("https://discord.gg/BxjqHMMsTb")
  DiscordLib:Notification("Đã Sao Chép Link Discord" , 10 ,11816162894 )
	end
...
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    while task.wait() do
    pcall(function()
        if game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=17451008055" then
           FullMoonStatus = "100%"
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=17451008055" then
            FullMoonStatus = "75%"
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=17451008055" then
            FullMoonStatus = "50%"
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=17451008055" then
    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "rbxassetid://17451008055" then
                    return v
                end
            end
        end
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "rbxassetid://17451008055"
...
Tabs.Misc:AddButton({
	...
	Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://17451008055")[1]:GetChildren()) do
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://17451008055"
...
spawn(function()
    while wait() do
        ...
        if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=17451008055" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=17451008055" then
            wait(2.0)
        elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=17451008055" then
            Hop()
            Fluent:Notify({
...
Fluent:Notify({
    Title = "Banana Hub",
    Content = "New Update 12/5/2024
    - Nút Stop Tween",
    Durtion = 3
})
warn("Update Chỉnh Sửa Lại 1 Số Chức Năng !!")
